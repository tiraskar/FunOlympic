                                ...
                                <table class="table">
                                    ...
                                    <tr>
                                        ...
                                        while ($res= mysqli_fetch_assoc($qu)){ ?>
                                            ...
                                            <td><button class="btn btn-danger" ><a href="delete.php?id=<?=$res['id']?>" style="color:white">Delete</a></button>
                                        <button class="btn btn-success" ><a href="forgot.php" style="color:white">Reset Password</a></button>  
                                        </td>
                                ...
                                <table class="table">
                                    ...
                                    <tr>
                                        ...
                                        while ($res= mysqli_fetch_assoc($qu)){ ?>
                                            ...
                                            <td><button class="btn-danger btn"><a class="text-white" href="deletemessage.php?id=<?=$res['id']?>">Delete</a></button></td>
                                            </tr>
                                        <?php }
                                        ?>
